...
client.connect(async err => {
  const collection = await client.db("foodfinder").collection("matches").createIndex( { name: "text", description: "text" } )//.insertMany(data); //clears collection and inserts data
